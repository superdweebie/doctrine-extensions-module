...
use Sds\DoctrineExtensionsModule\Test\TestAsset\Document;
...
class TestData{
    ...
    public static function create($documentManager){
        ...
        $documentManager->getConnection()->selectDatabase('doctrineExtensionsModuleTest');
    ...
    public static function remove($documentManager){
        ...
        $collections = $documentManager->getConnection()->selectDatabase('doctrineExtensionsModuleTest')->listCollections();
