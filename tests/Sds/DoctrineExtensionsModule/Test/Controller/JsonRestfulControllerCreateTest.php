...
class JsonRestfulControllerCreateTest extends AbstractHttpControllerTestCase{
    ...
    public function testCreate(){
        ...
        $game = $this->documentManager->getRepository('Sds\DoctrineExtensionsModule\Test\TestAsset\Document\Game')->find('forbidden-island');
    ...
    public function testCreateValidationFail(){
        ...
        $this->assertEquals('This value is required.', $result['validatorMessages']['type'][0]);
    }
    ...
    public function testEmbeddedCreateListItem(){
        ...
        $game = $this->documentManager->getRepository('Sds\DoctrineExtensionsModule\Test\TestAsset\Document\Game')->find('seven-wonders');
    ...
    public function testDeedNestedEmbeddedOneCreate(){
        ...
        $this->documentManager->clear();
        $country = $this->documentManager->getRepository('Sds\DoctrineExtensionsModule\Test\TestAsset\Document\Country')->find('belgum');
